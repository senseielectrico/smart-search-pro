...
def test_imports():
    ...
    try:
        from sevenzip_manager import SevenZipManager, CompressionLevel, ArchiveFormat, ExtractionProgress
    ...
    try:
        from recursive_extractor import RecursiveExtractor, RecursiveProgress
    ...
    try:
        from password_cracker import PasswordCracker, CrackProgress
    ...
    try:
        from archive_analyzer import ArchiveAnalyzer, ArchiveStats
